...
import com.example.demo.controller.ContentOfTheMachineController;
...
@Service
public class ContentOfTheMachineControllerImpl implements ContentOfTheMachineController {
    @Autowired
    private ContentOfTheMachineService elem;
    @Override
